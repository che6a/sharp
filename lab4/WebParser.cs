...
namespace d0gge
{
  public class WebParser : IDisposable
  {
    ...
    // метод для уничтожения инстанса класса
    public void Dispose()
    {
      _client.Dispose();
    ...
    // метод для сбора и анализа ссылок со скачанной страницы
    // filePath - путь к файлу(скачанной странице)
